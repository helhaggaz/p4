...
@section('content')
    ...
    <div class="container">
        <form method='POST' action='/applicant'>
            ...
            <div class='form-group'>
                <label for='can_relocate'><input type='checkbox' name='can_relocate' id='can_relocate' {{ (old('can_relocate')==1) ? 'checked' : ''}}> Can Relocate if required ?</label>
            </div>
            <div class='form-group'>
                <label for='experience'>* Years of Experience </label>
                <input type='text' max='3' name='experience' id='experience' value='{{ old('experience') }}'>
            ...
            <div class='form-group'>
                ...
                <input type='text' name='address_line_3' id='address_line_3' value='{{ old('address_line_3') }}'>
            </div>
            <div class='form-group'>
            ...
            <input type='submit' value='Create Applicant' class='btn btn-primary btn-small'>
